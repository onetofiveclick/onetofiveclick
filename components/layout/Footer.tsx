        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-bold text-xl text-white">One to Five Click</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/services/social-media" className="hover:text-blue-400 transition-colors">
              ...
              <li>
                <Link href="/services/content-writing" className="hover:text-blue-400 transition-colors">
                  Content Writing
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center space-x-2">
                ...
                <span>info@onetofiveclick.com</span>
              </li>
              <li>
                <Link
                  href="/contact"
