...
export const metadata: Metadata = {
  title: 'بناء الإشارات المحلية (Citations) في السعودية | ون تو فايف كليك',
  description: 'عزز ثقة محركات البحث والعملاء في السعودية من خلال بناء اقتباسات وإشارات محلية دقيقة (NAP) في الرياض، جدة، والدمام.',
  alternates: {
