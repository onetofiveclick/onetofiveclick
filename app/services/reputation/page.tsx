...
import { Star, ShieldCheck, HeartPulse, MessageSquare, ArrowLeft, TrendingUp } from 'lucide-react';
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <div className="inline-flex items-center gap-3 bg-white/5 text-brand-green px-6 py-2 rounded-full text-[10px] font-black uppercase tracking-[0.3em] mb-12 border border-white/10 backdrop-blur-md">
                ...
                <span>إدارة السمعة الرقمية (Reputation Management)</span>
              </div>
              <h1 className="text-5xl md:text-8xl font-black text-white mb-12 leading-[0.85] tracking-tighter">
                السمعة الرقمية <br />
                <span className="text-brand-green uppercase">هي رأس مالك.</span>
              </h1>
              <p className="text-xl md:text-2xl text-slate-400 mb-16 leading-relaxed font-bold max-w-2xl mx-auto">
                نحن نحمي ونعزز صورة علامتك التجارية في السوق السعودي. من خلال استراتيجيات استباقية للرد على المراجعات وتضخيم رأي العملاء الإيجابي عبر المنصات الرقمية.
              </p>
      ...
      <section className="py-24 bg-slate-50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="text-center mb-16">
              <h2 className="text-4xl md:text-6xl font-black text-brand-navy mb-6 tracking-tighter uppercase">حماية <span className="text-brand-green">البراند.</span></h2>
              <p className="text-slate-500 font-bold max-w-2xl mx-auto">نظامنا المتكامل يضمن بقاء علامتك التجارية في المقدمة بثقة عالية.</p>
           </div>
           <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { title: 'تحليل المشاعر (Sentiment Analysis)', desc: 'نراقب ما يُقال عنك باللغتين العربية والإنجليزية لفهم الاتجاه العام لجمهورك.', icon: HeartPulse },
                { title: 'الاستجابة الاستراتيجية', desc: 'إدارة محترفة للمراجعات السلبية وتعظيم تأثير المراجعات الإيجابية على قرار الشراء.', icon: MessageSquare },
                { title: 'بناء تدفق المراجعات', desc: 'أتمتة طلب التقييمات من عملائك الراضين لتغذية ملف شركتك (Google Business Profile).', icon: TrendingUp }
              ].map((item, i) => {
      ...
      <section className="py-24 bg-brand-navy relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
           <div className="text-right mb-16">
              ...
              <p className="text-slate-400 font-bold max-w-xl mr-0 ml-auto">نقوم بإدارة السمعة للمؤسسات عبر المحاور الاقتصادية الأساسية في المملكة.</p>
           </div>
           <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { city: 'الرياض', desc: 'إدارة السمعة لقطاع المال والأعمال والمطاعم الفاخرة.', link: '/locations/riyadh/' },
                { city: 'جدة', desc: 'بناء صورة الثقة للتجزئة والخدمات في العروس.', link: '/locations/jeddah/' },
                { city: 'الدمام', desc: 'موثوقية شركات المقاولات والخدمات في الشرقية.', link: '/locations/dammam/' }
              ].map((loc, i) => (
                <Link 
                  href={loc.link} 
                  key={i}
